...
void AirTank::send_feedback(DashboardServer* dashboard) {
  ...
  dashboard->update_value("AirTank_NextState", state_str);
  ...
  dashboard->update_value("AirTank_CurrState", state_str);
}
